...
export const sendConfirmationMail = async (data: FormSchema) => {
  ...
  const mailOptions: Mail.Options = {
    ...
    to: data.email,
    // bcc: "juergen.wohlgemuth@westfalen.dlrg.de",
    replyTo: "Juergen Wohlgemuth <juergen.wohlgemuth@westfalen.dlrg.de>",
